...
public class InlämningsUppgift02v2 {
     ...
     * @return i
     */
    protected int findID(String customerNr, String pnr){
        int i;
 ...
 * @return i
 */
     protected int findName(String customerName, String name){
 ...
 * @return paid
 */
     protected int compareLastInlogg(String date){
        int paid;
      ...
      * @return gymMember
      */
      protected String checkMembership(int paid){
        String gymMember;
    ...
    try(PrintWriter write = new PrintWriter(Files.newBufferedWriter(outFilePath,
       ...
       Scanner fileScanner = new Scanner(inFilename); 
        while (fileScanner.hasNext()){
          ...
          //finnsPersonNamn = pnrAndName[1];
          
           if(findID(finnsPersonNummer,pnr) == 1){  // make a new loop with || findName(finnsPersonNamn, pnr) == 1
              System.out.println("\n"+firstLine);
